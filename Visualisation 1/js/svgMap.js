...
svgMap.prototype.createMap = function () {
  ...
  Object.keys(mapPaths).forEach(function (countryID) {
    ...
    countryElement.addEventListener('mouseenter', function (e) {
      ...
      this.setTooltipContent(this.getTooltipContent(countryID));
      this.showTooltip(e);
      exposeCountryMousedOver(countryID);
    }.bind(this));
...
function exposeCountryMousedOver(country){
...
svgMap.prototype.getTooltipContent = function (countryID) {
  ...
  var tooltipGraph = this.createElement('div', 'svgMap-tooltip-graph', tooltipContentWrapper);
  tooltipGraph.id = "svgMap-tooltip-graph";
